...
@php $a = time() - $hospital->entry_date; $date = date('d', $a) @endphp
@else
    ...
    <div class="col-lg-5">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <td width="20px">:</td>
                            <td>{{ $handler->name_handler }}</td>
                        </tr>
                        <tr>
                            <th>Phone</th>
                            <td width="20px">:</td>
                            <td>{{ $handler->phone_handler }}</td>
                        </tr>
                        <tr>
                            <th>Job</th>
                            <td width="20px">:</td>
                            <td>{{ $handler->job_handler }}</td>
                        </tr>
                        <tr>
                            <th>Address</th>
                            <td width="20px">:</td>
                            <td>{{ $handler->address_handler }}</td>
                        </tr>
                        <tr>
                            <th>Family patient</th>
                            <td width="20px">:</td>
                            <td>{{ $handler->familyPatient->name }}</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="p-0"></td>
                        </tr>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if (!is_null($hospital->exit_date))
                <a href="/backend/hospitalization/pdf_show/{{ $hospital->id }}" class="btn btn-primary float-right">Create invoice</a>
                @endif
            </div>
        </div>
    </div>

                                ...
                                <div class="card">
                                    <div class="card-body text-left">
                                        ...
                                        @csrf
                                            ...
                                            <p class="text-muted mb-5 text-center">Sign In to your account</p>
                                            ...
                                            <div class="row mt-5">
												...
												<div class="col-12 text-center">
													<a href="/auth/register" class="btn btn-link box-shadow-0 px-0">Belum punya akun ?</a>
												</div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer py-2 text-center">
                                        <a href="/" class="btn btn-link text-decoration-none box-shadow-0 px-0"><i class="fa fa-arrow-left"></i> Back to home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
